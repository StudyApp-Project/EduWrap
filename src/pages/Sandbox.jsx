    ...
    <div className="p-8 max-w-7xl mx-auto space-y-12">
      <div>
        ...
        <section className="mb-12">
          <h2 className="text-xl font-semibold mb-4 border-b border-[var(--border-default)] pb-2">Buttons</h2>
        ...
        <section className="mb-12">
          <h2 className="text-xl font-semibold mb-4 border-b border-[var(--border-default)] pb-2">Inputs</h2>
        ...
        <section className="mb-12 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-xl font-semibold mb-4 border-b border-[var(--border-default)] pb-2">Cards & Avatars</h2>
            <Card className="mb-4">
              <CardHeader>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-4 border-b border-[var(--border-default)] pb-2">Data Display</h2>
        ...
        <section className="mb-12">
          <h2 className="text-xl font-semibold mb-4 border-b border-[var(--border-default)] pb-2">Navigation & Overlays</h2>
        ...
        <section className="mb-12 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-xl font-semibold mb-4 border-b border-[var(--border-default)] pb-2">Empty States</h2>
            <EmptyState 
              icon={Folder}
              title="No files yet"
          ...
          <div>
            <h2 className="text-xl font-semibold mb-4 border-b border-[var(--border-default)] pb-2">Skeletons</h2>
